...
BASELINE = {
    ...
    "src/cassian_engine.py": "68c7159c555ef85f1d81574707796950df1d6a9969c0bee5b944cf148e31b2d3",  # re-baselined from c9b536d4 (undef remediation: _cand_misuse helper, vty import, cmd_test rebinds + scenarios reads, resolve_topology names); orig f3831817
