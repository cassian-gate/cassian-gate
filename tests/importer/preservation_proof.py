...
BASELINE = {
    ...
    "src/cassian_nos_sonic.py": "44aae825c1d6fc6b019666135cb7198e6ed1f31225e073b2012f208ea148f214",  # re-baselined from d4e1cabd (WI-1 packet 3a: REQ-45C-44(b) routing-mode precondition; ast import + assert_routing_mode_clean); §4.5-c new module (WI-1 SONiC provider); enforced (REQ-45C-39; LD-9)
