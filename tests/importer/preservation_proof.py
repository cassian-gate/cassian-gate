...
BASELINE = {
    ...
    "src/cassian_engine.py": "5b25a6cf924fb83c4e333ed49072d265558afb53b14b3faad384f49fd8904d3d",  # re-baselined from 5db2f9eb (BL-P2-4.5c-44: unsupported-capability guard at 7 invariant branches, founder ruling 2026-08-22); prior 10530484; orig f3831817
    ...
    "src/cassian_nos_sonic.py": "7d3da7d016ab3ea03a2b73398cc76feae57d18cc61b7fce6d80f926bbb8dac35",  # re-baselined from d4e1cabd (WI-1 packet 3a: REQ-45C-44(b) routing-mode precondition; ast import + assert_routing_mode_clean); §4.5-c new module (WI-1 SONiC provider); enforced (REQ-45C-39; LD-9)
