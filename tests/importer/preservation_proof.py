...
BASELINE = {
    ...
    "src/cassian_engine.py": "9c81957410547f3f014ac94698059410e04eab4e1cd45af26b18d5cbe18bceb2",  # re-baselined from 68c7159c (BL-P2-4.5c-29 part (a): VM-runtime reachability gate in _provision_nos_providers); orig f3831817
