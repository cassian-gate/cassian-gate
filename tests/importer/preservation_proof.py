...
BASELINE = {
    ...
    "src/cassian_engine.py": "10530484df5688bfe6df5576463be7b8bd77e4ee87a9207d196939d21bf852d8",  # re-baselined from fe9ca9db (§4.5-c WI-7: EVPN text collection migrated to the provider seam, REQ-45C-14); orig f3831817
