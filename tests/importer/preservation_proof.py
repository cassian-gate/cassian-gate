...
BASELINE = {
    ...
    "src/cassian_engine.py": "fe9ca9db8f4a46df6d8b4f78bbacbcb67a84584a53b33dc62c9a9d750b9be8b8",  # re-baselined from 9c819574 (BL-P2-4.5c-29 part (b): marker-guarded nos_ready dispatch); orig f3831817
